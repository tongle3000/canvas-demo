...
export class M4Component implements OnInit {
  ...
  initScene() {
    ...
    // steve -> dragon
    loader.load('assets/models/dragon/scene.gltf', (gltf: any) => {
      scene.add(gltf.scene);
      gltf.scene.scale.set(0.6, 0.6, 0.6); // (0.2, 0.2, 0.2) -> (1, 1, 1)放大
      gltf.scene.position.set(0, 8, 0); // (x坐标, z坐标, y坐标) 3.2 站在地面上 人高度是6.4
